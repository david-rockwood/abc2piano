...
* **Output:** WAV / MP3 / Opus
* **Extras:** basic reverb presets, realistic piano SoundFont, select your own SoundFont
...
All of this gives you a simple app you can use to test your ABC files as you write them. You can instantly hear a clean piano rendering of your song without dealing with command-line tools or technical setup. You can also select an SF2 SoundFont that you have on your hard drive. When you're satisfied, just export the audio.
